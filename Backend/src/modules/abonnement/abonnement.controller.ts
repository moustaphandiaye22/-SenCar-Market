...
import { ActivateBoostRequestDto } from "./dto/activate-boost-request.dto";
...
export class AbonnementController {
  ...
  @ApiResponse({
    status: 403,
    type: ApiErrorResponseDto,
    description: "Interdit - Accès refusé",
  })
  @ApiResponse({
    status: 500,
    type: ApiErrorResponseDto,
  ...
  @ApiResponse({
    status: 201,
    type: UtilisateurAbonnementResponseDto,
  ...
  getSubscriptionsHistory(
    ...
    return this.service.getSubscriptionsHistory(
      utilisateurId,
      page,
      size,
      user,
  ...
  @ApiResponse({
    status: 201,
    type: BoostAnnonceResponseDto,
    description: "Boost créé avec succès",
  })
  @ApiResponse({
    status: 400,
    type: ApiErrorResponseDto,
  ...
  @ApiResponse({
    status: 200,
    type: BoostAnnonceResponseDto,
    description: "Boost mis à jour avec succès",
  })
  @ApiResponse({
    status: 400,
    type: ApiErrorResponseDto,
  ...
  @ApiOperation({ summary: "Activer un boost après paiement confirmé" })
  @ApiResponse({
    status: 200,
    type: BoostAnnonceResponseDto,
    description: "Boost activé avec succès",
  })
  @ApiResponse({
    status: 400,
    type: ApiErrorResponseDto,
    description: "Paiement non confirmé ou incompatible",
  })
  @ApiResponse({
    status: 401,
    type: ApiErrorResponseDto,
  ...
  @ApiResponse({
    status: 404,
    type: ApiErrorResponseDto,
    description: "Boost ou paiement non trouvé",
  })
  @ApiResponse({
    status: 500,
    type: ApiErrorResponseDto,
  ...
  async activateBoost(
    @Param("id", new ParseUUIDPipe()) id: string,
    @Body() request: ActivateBoostRequestDto,
    @CurrentUser() user: AuthenticatedUser,
  ): Promise<BoostAnnonceResponseDto> {
    return this.service.activateBoost(id, request.paymentId, user);
  }

  @Post("souscriptions/:id/activate")
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: "Activer un abonnement après paiement confirmé" })
  @ApiResponse({
    status: 200,
    type: UtilisateurAbonnementResponseDto,
  ...
  @ApiResponse({
    status: 404,
    type: ApiErrorResponseDto,
    description: "Abonnement ou paiement non trouvé",
  })
  @ApiResponse({
    status: 500,
    type: ApiErrorResponseDto,
  ...
  async activateSubscription(
    @Param("id", new ParseUUIDPipe()) id: string,
    @Body() request: ActivateSubscriptionRequestDto,
    @CurrentUser() user: AuthenticatedUser,
  ): Promise<UtilisateurAbonnementResponseDto> {
    return this.service.activateSubscription(id, request.paymentId, user);
  }
  ...
  @ApiResponse({
    status: 200,
    type: BoostAnnonceResponseDto,
    description: "Boost récupéré avec succès",
  })
  @ApiResponse({
    status: 401,
    type: ApiErrorResponseDto,
  ...
  @ApiResponse({
    ...
    type: BoostAnnonceResponseDto,
    isArray: true,
    description: "Boosts récupérés avec succès",
  })
  @ApiResponse({
    status: 401,
    type: ApiErrorResponseDto,
